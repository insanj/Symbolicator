...
- (void)_extractBinaryImageInfoFromSymbolOwner:(_CSTypeRef)arg1;
- (double)_extractDyldInfoFromSymbolOwner:(_CSTypeRef)arg1 withNonContiguousMemory:(id)arg2;
- (id)_extractInfoPlistFromSymbolOwner:(_CSTypeRef)arg1 withNonContiguousMemory:(id)arg2;
